...
$graph:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:   
        dockerPull: ghcr.io/terradue/app-package-training-bids23/crop:1.0.0
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/terradue/app-package-training-bids23/norm_diff:1.0.0
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      rasters:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/terradue/app-package-training-bids23/otsu:1.0.0
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      raster:
  ...
  - class: CommandLineTool
    ...
    hints:
      DockerRequirement:
        dockerPull: ghcr.io/terradue/app-package-training-bids23/stac:1.0.0
    baseCommand: ["python", "-m", "app"]
    arguments: []
    inputs:
      item:
